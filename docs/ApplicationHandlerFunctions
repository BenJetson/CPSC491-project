...
* Once authentication and formatting is checked, then either receive the data being sent over or send 
information to the database depending on the handler function being implemented
